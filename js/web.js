$(document).ready(function(){
  ...
  $('.boton_contacto').click(function() {
    ...
    $('body').css('overflow-y','hidden');
    //////////////////////////////////////////////////////////////////////////////////////////////////
    // CALCULAR MARGIN-TOP y MARGIN-BOTTOM EN MODAL CONTACTO
    function calculosContacto(){
      var windowTop = $(document).scrollTop();
      var windowBottom = windowTop + window.innerHeight;
      var elementPositionTop = $('.contenedor_modal_contacto').offset().top;
      var elementPositionBottom = elementPositionTop + $('.contenedor_modal_contacto').height();

      var arrayCalculosContacto = [ windowBottom, elementPositionBottom ];
      return arrayCalculosContacto;
    }

    function addMarginContacto(){
      var arrayCalculosContacto = calculosContacto(arrayCalculosContacto);
      var windowBottom = parseInt(arrayCalculosContacto.slice(0, 1));
      var elementPositionBottom = parseInt(arrayCalculosContacto.slice(1, 2));
      var margenes = ((windowBottom - elementPositionBottom) / 2);

      if( (windowBottom >= (elementPositionBottom + 60)) && (($(window).width()) > 1200) ){
        $('.contenedor_modal_contacto').css({
          'margin-top' : margenes + 'px',
          'margin-bottom' : margenes + 'px'
        });
      }else{
        $('.contenedor_modal_contacto').css({
          'margin-top' : 40 + 'px',
